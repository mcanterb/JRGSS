...
public abstract class AbstractRenderable implements Comparable<AbstractRenderable> {
    ...
    public int compareTo(AbstractRenderable other) {
        ...
        if (other == this) {
            ...
            int z1 = o1.getViewport() == null ? o1.getZ() : o1.getViewport().getZ();
            int z2 = o2.getViewport() == null ? o2.getZ() : o2.getViewport().getZ();
            int ret = Integer.compare(z1, z2);
            if (ret != 0) return ret;
            int y1 = o1.getViewport() != null ?
                o1.getViewport().getY() : o1.getY();
            int y2 = o2.getViewport() != null ?
                o2.getViewport().getY() : o2.getY();
            ret = Integer.compare(y1, y2);
            return ret != 0 ? ret : Long.compare(o1.getCreationTime(), o2.getCreationTime());
        }
    }
