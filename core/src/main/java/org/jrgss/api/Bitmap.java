...
public class Bitmap {
   ...
   public Bitmap(int width, int height) {
      ...
      this.hiRes = true;
      this.loadedScale = Graphics.hiResScale;
      this.runAndRecord(() -> {
         if (width != 0 && height != 0) {
   ...
   private void reload() {
      if (this.hiRes && !(Math.abs(Graphics.hiResScale - this.loadedScale) < 1.0E-4)) {
   ...
   public void draw_text(int x1, int y1, int width1, int height1, Object obj, int align) {
      ...
      this.runAndRecord(() -> {
         ...
         if (!this.hiRes) {
            ...
            BitmapFontData fontData = font.getBitmapFont().getData();
            if (font.isOutline()) {
               for (char c : string.toCharArray()) {
                  if (c == ' ') {
                     ...
                     float fontWidth = getGlyph(fontData, c).xadvance;
                     outline.draw(batch, charBuffer, fontDrawX, (float)drawY);
                     fontDrawX += fontWidth;
                  }
               }
            } else {
            ...
            if (this$path == null ? other$path == null : this$path.equals(other$path)) {
               ...
               if (this$font == null ? other$font == null : this$font.equals(other$font)) {
                  if (this.getWidth() != other.getWidth()) {
                     ...
                     if (this$frameBuffer == null ? other$frameBuffer == null : this$frameBuffer.equals(other$frameBuffer)) {
                        Object this$region = this.getRegion();
                        Object other$region = other.getRegion();
                        if (this$region == null ? other$region == null : this$region.equals(other$region)) {
                           Object this$pixmap = this.getPixmap();
                           Object other$pixmap = other.getPixmap();
                           if (this$pixmap == null ? other$pixmap == null : this$pixmap.equals(other$pixmap)) {
                              ...
                              if (this$camera == null ? other$camera == null : this$camera.equals(other$camera)) {
                                 ...
                                 if (this$isDisposed == null ? other$isDisposed == null : this$isDisposed.equals(other$isDisposed)) {
                                    if (this.getId() != other.getId()) {
                                       ...
                                       return (
                                             this$reloadRunnables == null ? other$reloadRunnables == null : this$reloadRunnables.equals(other$reloadRunnables)
                                          )
                                          ? this.isHiRes() == other.isHiRes()
                                          : false;
                                    }
                                 } else {
                                    return false;
