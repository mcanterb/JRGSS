...
public class Color extends RubyObject implements Serializable, Cloneable {
   ...
   public void initialize(ThreadContext context, IRubyObject[] args) {
      ...
      if (args.length != 0) {
         this.red = this.clamp(Win32Util.getInt(args[0]), 0, 255);
         this.green = this.clamp(Win32Util.getInt(args[1]), 0, 255);
         this.blue = this.clamp(Win32Util.getInt(args[2]), 0, 255);
         this.alpha = args.length == 4 ? this.clamp(Win32Util.getInt(args[3]), 0, 255) : 255;
      }
   }
   ...
   public void set(int r, int g, int b, int alpha) {
      ...
      this.alpha = this.clamp(alpha, 0, 255);
   }
   ...
   public IRubyObject red_set(IRubyObject arg) {
      return Win32Util.rubyNum(this.red = this.clamp(Win32Util.getInt(arg), 0, 255));
   }
   ...
   public IRubyObject green_set(IRubyObject arg) {
      return Win32Util.rubyNum(this.green = this.clamp(Win32Util.getInt(arg), 0, 255));
   }
   ...
   public IRubyObject blue_set(IRubyObject arg) {
      return Win32Util.rubyNum(this.blue = this.clamp(Win32Util.getInt(arg), 0, 255));
   }
   ...
   public IRubyObject alpha_set(IRubyObject arg) {
      return Win32Util.rubyNum(this.alpha = this.clamp(Win32Util.getInt(arg), 0, 255));
   }
