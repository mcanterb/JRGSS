...
public class RGSSBuiltinService implements BasicLibraryService {
    ...
    private static final List<Class<? extends RubyObject>> builtInModules = new ArrayList<Class<? extends RubyObject>>() {
        {
            add(Graphics.class);
        }
    };
    ...
    public boolean basicLoad(Ruby runtime) throws IOException {
        ...
        RubyModule graphicsModule = runtime.defineModule("Graphics");
        graphicsModule.defineAnnotatedMethods(Graphics.class);
        this.betterLoadConstants(Graphics.class, graphicsModule);
        Graphics.runtime = runtime;
        Graphics.rubyClass = graphicsModule;
        RubyModule audioModule = runtime.defineModule("Audio");
        audioModule.defineAnnotatedMethods(Audio.class);
        this.betterLoadConstants(Audio.class, audioModule);
        Audio.runtime = runtime;
        Audio.rubyModule = audioModule;
