...
public class Sprite extends AbstractRenderable {
    ...
    public void render(JrgssBatch batch) {
        ...
        if (this.bitmap != null && this.visible && this.opacity > 0 && (this.viewport == null || this.viewport.isVisible() && !this.viewport.isDisposed())) {
            ...
            AlphaBlendingShader.withToneChange(tone, batch, () -> {
                ...
                int bush_depth = (int) Math.min(this.bush_depth, this.src_rect.getHeight());
    ...
    public void setBitmap(Bitmap b) {
        ...
        if (b != null) {
            ...
            GamePatches.onSpriteCreate(this);
        }
    }
        ...
        if (o == this) {
            ...
            if (!other.canEqual(this)) {
                ...
                if (Objects.equals(this$bitmap, other$bitmap)) {
                    ...
                    if (Objects.equals(this$src_rect, other$src_rect)) {
                        ...
                        if (Objects.equals(this$viewport, other$viewport)) {
                            if (this.isVisible() != other.isVisible()) {
                                ...
                                if (Objects.equals(this$color, other$color)) {
                                    ...
                                    return Objects.equals(this$tone, other$tone);
                                } else {
                                    return false;
                                }
                            }
