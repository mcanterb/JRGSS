...
public class Tilemap {
    ...
    public Tilemap(Viewport viewport) {
        ...
        for (int i = 0; i < 6; i++) {
            this.layers[i] = i != 5 ? new TileMapLayer(i) : new ShadowLayer();
        }
    }
    ...
    private static boolean isWall(int data) {
        return data > 7807 || inRange(WALL_RANGES, data);
    }
                                ...
                                if (Objects.equals(this$flash_data, other$flash_data)) {
                                    ...
                                    if (Objects.equals(this$flags, other$flags)) {
                                        if (this.isVisible() != other.isVisible()) {
                                            ...
                                            return this.isNeedRefresh() == other.isNeedRefresh() && Arrays.deepEquals(this.getLayers(), other.getLayers());
                                        }
                                    } else {
                                        return false;
                                    }
