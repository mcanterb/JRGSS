...
public class Window extends AbstractRenderable {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         if (!other.canEqual(this)) {
            ...
            if (this$windowskin == null ? other$windowskin == null : this$windowskin.equals(other$windowskin)) {
               ...
               if (this$contents == null ? other$contents == null : this$contents.equals(other$contents)) {
                  ...
                  if (this$cursor_rect == null ? other$cursor_rect == null : this$cursor_rect.equals(other$cursor_rect)) {
                        ...
                        if (this.isActive() != other.isActive()) {
                           ...
                           if (this$tone == null ? other$tone == null : this$tone.equals(other$tone)) {
                              if (this.isDisposed() != other.isDisposed()) {
                                 ...
                                 if (this$baseWindowSkin == null ? other$baseWindowSkin == null : this$baseWindowSkin.equals(other$baseWindowSkin)) {
                                    ...
                                    if (this$background == null ? other$background == null : this$background.equals(other$background)) {
                                       ...
                                       if (this$upperleft == null ? other$upperleft == null : this$upperleft.equals(other$upperleft)) {
                                          Object this$lowerleft = this.getLowerleft();
                                          Object other$lowerleft = other.getLowerleft();
                                          if (this$lowerleft == null ? other$lowerleft == null : this$lowerleft.equals(other$lowerleft)) {
                                             Object this$upperright = this.getUpperright();
                                             Object other$upperright = other.getUpperright();
                                             if (this$upperright == null ? other$upperright == null : this$upperright.equals(other$upperright)) {
                                                Object this$lowerright = this.getLowerright();
                                                Object other$lowerright = other.getLowerright();
                                                if (this$lowerright == null ? other$lowerright == null : this$lowerright.equals(other$lowerright)) {
                                                   Object this$horizontalTop = this.getHorizontalTop();
                                                   Object other$horizontalTop = other.getHorizontalTop();
                                                   if (this$horizontalTop == null
                                                      ? other$horizontalTop == null
                                                      : this$horizontalTop.equals(other$horizontalTop)) {
                                                      Object this$horizontalBottom = this.getHorizontalBottom();
                                                      Object other$horizontalBottom = other.getHorizontalBottom();
                                                      if (this$horizontalBottom == null
                                                         ? other$horizontalBottom == null
                                                         : this$horizontalBottom.equals(other$horizontalBottom)) {
                                                         Object this$verticalLeft = this.getVerticalLeft();
                                                         Object other$verticalLeft = other.getVerticalLeft();
                                                         if (this$verticalLeft == null
                                                            ? other$verticalLeft == null
                                                            : this$verticalLeft.equals(other$verticalLeft)) {
                                                            Object this$verticalRight = this.getVerticalRight();
                                                            Object other$verticalRight = other.getVerticalRight();
                                                            if (this$verticalRight == null
                                                               ? other$verticalRight == null
                                                               : this$verticalRight.equals(other$verticalRight)) {
                                                               Object this$upperleftCursor = this.getUpperleftCursor();
                                                               Object other$upperleftCursor = other.getUpperleftCursor();
                                                               if (this$upperleftCursor == null
                                                                  ? other$upperleftCursor == null
                                                                  : this$upperleftCursor.equals(other$upperleftCursor)) {
                                                                  Object this$lowerleftCursor = this.getLowerleftCursor();
                                                                  Object other$lowerleftCursor = other.getLowerleftCursor();
                                                                  if (this$lowerleftCursor == null
                                                                     ? other$lowerleftCursor == null
                                                                     : this$lowerleftCursor.equals(other$lowerleftCursor)) {
                                                                     Object this$upperrightCursor = this.getUpperrightCursor();
                                                                     Object other$upperrightCursor = other.getUpperrightCursor();
                                                                     if (this$upperrightCursor == null
                                                                        ? other$upperrightCursor == null
                                                                        : this$upperrightCursor.equals(other$upperrightCursor)) {
                                                                        Object this$lowerrightCursor = this.getLowerrightCursor();
                                                                        Object other$lowerrightCursor = other.getLowerrightCursor();
                                                                        if (this$lowerrightCursor == null
                                                                           ? other$lowerrightCursor == null
                                                                           : this$lowerrightCursor.equals(other$lowerrightCursor)) {
                                                                           Object this$horizontalTopCursor = this.getHorizontalTopCursor();
                                                                           Object other$horizontalTopCursor = other.getHorizontalTopCursor();
                                                                           if (this$horizontalTopCursor == null
                                                                              ? other$horizontalTopCursor == null
                                                                              : this$horizontalTopCursor.equals(other$horizontalTopCursor)) {
                                                                              ...
                                                                              if (this$horizontalBottomCursor == null
                                                                                 ? other$horizontalBottomCursor == null
                                                                                 : this$horizontalBottomCursor.equals(other$horizontalBottomCursor)) {
                                                                                 Object this$verticalLeftCursor = this.getVerticalLeftCursor();
                                                                                 Object other$verticalLeftCursor = other.getVerticalLeftCursor();
                                                                                 if (this$verticalLeftCursor == null
                                                                                    ? other$verticalLeftCursor == null
                                                                                    : this$verticalLeftCursor.equals(other$verticalLeftCursor)) {
                                                                                    Object this$verticalRightCursor = this.getVerticalRightCursor();
                                                                                    Object other$verticalRightCursor = other.getVerticalRightCursor();
                                                                                    if (this$verticalRightCursor == null
                                                                                       ? other$verticalRightCursor == null
                                                                                       : this$verticalRightCursor.equals(other$verticalRightCursor)) {
                                                                                       Object this$backgroundCursor = this.getBackgroundCursor();
                                                                                       Object other$backgroundCursor = other.getBackgroundCursor();
                                                                                       if (this$backgroundCursor == null
                                                                                          ? other$backgroundCursor == null
                                                                                          : this$backgroundCursor.equals(other$backgroundCursor)) {
                                                                                          Object this$downScroll = this.getDownScroll();
                                                                                          Object other$downScroll = other.getDownScroll();
                                                                                          if (this$downScroll == null
                                                                                             ? other$downScroll == null
                                                                                             : this$downScroll.equals(other$downScroll)) {
                                                                                             Object this$upScroll = this.getUpScroll();
                                                                                             Object other$upScroll = other.getUpScroll();
                                                                                             if (this$upScroll == null
                                                                                                ? other$upScroll == null
                                                                                                : this$upScroll.equals(other$upScroll)) {
                                                                                                Object this$leftScroll = this.getLeftScroll();
                                                                                                Object other$leftScroll = other.getLeftScroll();
                                                                                                if (this$leftScroll == null
                                                                                                   ? other$leftScroll == null
                                                                                                   : this$leftScroll.equals(other$leftScroll)) {
                                                                                                   Object this$rightScroll = this.getRightScroll();
                                                                                                   Object other$rightScroll = other.getRightScroll();
                                                                                                   if (this$rightScroll == null
                                                                                                      ? other$rightScroll == null
                                                                                                      : this$rightScroll.equals(other$rightScroll)) {
                                                                                                      if (!Arrays.deepEquals(
                                                                                                         this.getPauses(), other.getPauses()
                                                                                                      )) {
                                                                                                         return false;
                                                                                                      } else if (this.getPauseCounter()
                                                                                                         != other.getPauseCounter()) {
                                                                                                         return false;
                                                                                                      } else if (this.getLastToneHash()
                                                                                                         != other.getLastToneHash()) {
                                                                                                         return false;
                                                                                                      } else if (Float.compare(
                                                                                                            this.getCursor_opacity(), other.getCursor_opacity()
                                                                                                         )
                                                                                                         != 0) {
                                                                                                         return false;
                                                                                                      } else {
                                                                                                         return Float.compare(
                                                                                                                  this.getCursor_inc(), other.getCursor_inc()
                                                                                                               )
                                                                                                               != 0
                                                                                                            ? false
   ...
   public String toString() {
      return "Window(x="
         ...
         + this.getOpacity()
         + ", back_opacity="
         + this.getBack_opacity()
         + ", contents_opacity="
         + this.getContents_opacity()
         + ", cursor_rect="
         + this.getCursor_rect()
         + ", viewport="
         + this.getViewport()
         ...
         + this.getLowerright()
         + ", horizontalTop="
         + this.getHorizontalTop()
         + ", horizontalBottom="
         + this.getHorizontalBottom()
         + ", verticalLeft="
         + this.getVerticalLeft()
         + ", verticalRight="
         + this.getVerticalRight()
         + ", upperleftCursor="
         + this.getUpperleftCursor()
         + ", lowerleftCursor="
         + this.getLowerleftCursor()
         + ", upperrightCursor="
         + this.getUpperrightCursor()
         + ", lowerrightCursor="
         + this.getLowerrightCursor()
         + ", horizontalTopCursor="
         + this.getHorizontalTopCursor()
         + ", horizontalBottomCursor="
         + this.getHorizontalBottomCursor()
         + ", verticalLeftCursor="
         + this.getVerticalLeftCursor()
         + ", verticalRightCursor="
         + this.getVerticalRightCursor()
         + ", backgroundCursor="
         + this.getBackgroundCursor()
         + ", downScroll="
         + this.getDownScroll()
         + ", upScroll="
         + this.getUpScroll()
         ...
         + this.getRightScroll()
         + ", pauses="
         + Arrays.deepToString(this.getPauses())
         + ", pauseCounter="
         + this.getPauseCounter()
         + ", lastToneHash="
         + this.getLastToneHash()
         + ", cursor_opacity="
         + this.getCursor_opacity()
         + ", cursor_inc="
         + this.getCursor_inc()
         + ", id="
         + this.getId()
