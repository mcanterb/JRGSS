...
public class Win32Util {
    ...
    public static boolean isNotNull(IRubyObject obj) {
    ...
    public static IRubyObject rubyNumClamped(long value) {
        return rubyNumClamped(value, 0, 255);
    }

    public static IRubyObject rubyNumClamped(long value, long min, long max) {
        return new RubyFixnum(Ruby.getGlobalRuntime(), clamp(value, min, max));
    }
