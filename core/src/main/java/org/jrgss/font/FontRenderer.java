...
public class FontRenderer {
   ...
   private static byte TAG_ONCURVE = 1;
   private static byte TAG_BEZIER3 = 2;
      ...
      protected FontRenderer.CurveIterator computeNext() {
         if (this.current == this.num) {
            ...
            FontRenderer.CurveIterator result = new FontRenderer.CurveIterator(
               this.points.share(this.start * FTGlyphSlot.FTVector.SIZE), this.tags.share(this.start), contourEnd - this.start + 1, 0
            );
            ...
            if (!other.canEqual(this)) {
               ...
               if (this$points == null ? other$points == null : this$points.equals(other$points)) {
                  ...
                  if (this$tags == null ? other$tags == null : this$tags.equals(other$tags)) {
                     ...
                     if (this$endIdx == null ? other$endIdx == null : this$endIdx.equals(other$endIdx)) {
                        Object this$lastIdx = this.lastIdx;
                        Object other$lastIdx = other.lastIdx;
                        if (this$lastIdx == null ? other$lastIdx == null : this$lastIdx.equals(other$lastIdx)) {
                           if (this.start != other.start) {
                              return false;
                           } else {
                              return this.num != other.num ? false : this.current == other.current;
                           }
                        } else {
                           return false;
                        }
   ...
   private static class Curve {
      ...
      public String toString() {
         return this.type() + "{ " + Arrays.toString((Object[])this.vectors) + " }";
      }
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            return !other.canEqual(this) ? false : Arrays.deepEquals(this.vectors, other.vectors);
         }
      }
   ...
   private static class CurveIterator extends AbstractIterator<FontRenderer.Curve> {
      ...
      public FTGlyphSlot.FTVector pt(int i) {
         return this.idx + i < this.length
            ? new FTGlyphSlot.FTVector(this.startPoint.share((this.idx + i) * FTGlyphSlot.FTVector.SIZE))
            : new FTGlyphSlot.FTVector(this.startPoint.share((this.idx + i - this.length) * FTGlyphSlot.FTVector.SIZE));
      }
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            if (!other.canEqual(this)) {
               ...
               if (this$startPoint == null ? other$startPoint == null : this$startPoint.equals(other$startPoint)) {
                  Object this$startTag = this.startTag;
                  Object other$startTag = other.startTag;
                  if (this$startTag == null ? other$startTag == null : this$startTag.equals(other$startTag)) {
                     return this.length != other.length ? false : this.idx == other.idx;
                  } else {
                     return false;
                  }
               } else {
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            if (!other.canEqual(this)) {
               ...
               return Float.compare(this.getHeight(), other.getHeight()) != 0 ? false : Float.compare(this.getSize(), other.getSize()) == 0;
            }
         }
      }
      ...
      public boolean equals(Object o) {
         if (o == this) {
            ...
            if (!other.canEqual(this)) {
               ...
               return Float.compare(this.getY(), other.getY()) != 0 ? false : Arrays.equals(this.getAccumulation(), other.getAccumulation());
            }
         }
      }
